 ...
 */
bool LIS3DH::detect() {
	return FRToSI2C2.probe(LIS3DH_I2C_ADDRESS);
}
...
#ifdef LIS_ORI_FLIP
	uint8_t valdebug = (FRToSI2C2.I2C_RegisterRead(LIS3DH_I2C_ADDRESS, LIS_INT2_SRC));
    uint8_t val = valdebug;
...
#else
    return static_cast<Orientation>((FRToSI2C2.I2C_RegisterRead(LIS3DH_I2C_ADDRESS, LIS_INT2_SRC) >> 2) - 1);

...
屏幕亮度90%，开启自动休眠，设置任务后，由RTC闹钟唤醒亮屏4秒，采集一次温湿度，数据保存在EEPROM，然后熄屏进入低功耗模式，在24小时如此反复约1200次，锂电池电压从4.2V降到4.0V，耗电约15%，串口导出的数据保存为csv文件，导入谷歌表格处理后的折线图如下：
...
屏幕亮度50%，开启自动休眠，设置任务后，由RTC闹钟唤醒亮屏5秒，采集一次温湿度，数据保存在EEPROM，然后熄屏进入低功耗模式，在38天如此反复约1800次（每天48次），锂电池电压从4.25V降到4.02V，耗电约15%，串口导出的数据保存为csv文件，导入谷歌表格处理后的折线图如下：
